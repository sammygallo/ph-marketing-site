(function (window, document) {
   ...
   *       "scheduling_link_1": "...",  // Get to know your Account Executive
   *       "scheduling_link_2": "...",  // Schedule a Platform Demo
   *       // ... other rep info
   *     }
   *   }
   * }
  ...
  class USMapController {
    ...
    createTerritories() {
      ...
      Object.keys(window.US_TERRITORIES_DATA).forEach((territoryId) => {
        ...
        if (territoryData.repInfo) {
          ...
          path.dataset.repSchedLink2 = territoryData.repInfo.scheduling_link_2 || "";
        }
    ...
    handleClick(e, element) {
      ...
      if (element.dataset.type === "territory" &&
          element.dataset.repSchedLink1 &&
          element.dataset.repSchedLink2) {
